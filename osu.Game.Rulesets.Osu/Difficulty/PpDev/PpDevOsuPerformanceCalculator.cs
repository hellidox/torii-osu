...
{
    public class PpDevOsuPerformanceCalculator : PerformanceCalculator
    {
        ...
        public PpDevOsuPerformanceCalculator()
            : base(new OsuRuleset())
        {
        }
        ...
        protected override PerformanceAttributes CreatePerformanceAttributes(ScoreInfo score, DifficultyAttributes attributes)
        {
            ...
            approachRate = PpDevOsuDifficultyCalculator.CalculateRateAdjustedApproachRate(difficulty.ApproachRate, clockRate);
            overallDifficulty = PpDevOsuDifficultyCalculator.CalculateRateAdjustedOverallDifficulty(difficulty.OverallDifficulty, clockRate);
            ...
            double cognitionValue = PpDevOsuDifficultyCalculator.SumCognitionDifficulty(readingValue, flashlightValue);
